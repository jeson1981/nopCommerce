...
namespace Nop.Services.Installation
{
    ...
    public static class ISO3166
    {
        ...
        public static IEnumerable<ISO3166Country> GetCollection()
        {
            ...
            return new[] {
                ...
                new ISO3166Country("Austria", "AT", "AUT", 40, new[] { "43" }, true),
                ...
                new ISO3166Country("Belgium", "BE", "BEL", 56, new[] { "32" }, true),
                ...
                new ISO3166Country("Bulgaria", "BG", "BGR", 100, new[] { "359" }, true),
                ...
                new ISO3166Country("Finland", "FI", "FIN", 246, new[] { "358" }, true),
                new ISO3166Country("France", "FR", "FRA", 250, new[] { "33" }, true),
                ...
                new ISO3166Country("Germany", "DE", "DEU", 276, new[] { "49" }, true),
                new ISO3166Country("Ghana", "GH", "GHA", 288, new[] { "233" }),
                new ISO3166Country("Gibraltar", "GI", "GIB", 292, new[] { "350" }),
                new ISO3166Country("Greece", "GR", "GRC", 300, new[] { "30" }, true),
                ...
                new ISO3166Country("Hungary", "HU", "HUN", 348, new[] { "36" }, true),
                ...
                new ISO3166Country("Italy", "IT", "ITA", 380, new[] { "39" }, true),
                ...
                new ISO3166Country("Latvia", "LV", "LVA", 428, new[] { "371" }, true),
                ...
                new ISO3166Country("Netherlands", "NL", "NLD", 528, new[] { "31" }, true),
                ...
                new ISO3166Country("Poland", "PL", "POL", 616, new[] { "48" }, true),
                ...
                new ISO3166Country("Romania", "RO", "ROU", 642, new[] { "40" }, true),
                ...
                new ISO3166Country("Slovakia", "SK", "SVK", 703, new[] { "421" }, true),
                new ISO3166Country("Slovenia", "SI", "SVN", 705, new[] { "386" }, true),
                ...
                new ISO3166Country("Spain", "ES", "ESP", 724, new[] { "34" }, true),
    ...
    {
        public ISO3166Country(string name, string alpha2, string alpha3, int numericCode, string[] dialCodes = null, bool subjectToVat = false)
        {
            Name = name;
            Alpha2 = alpha2;
            Alpha3 = alpha3;
